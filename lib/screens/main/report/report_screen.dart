        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Bulan " + DateTime.now().month.toString(), style: regularTextFont.copyWith(fontSize: fontSize(16), color: textColor()),),
              hSpace(15),
              Row(
              ...
              hSpace(15),
              Text("Daftar pengeluaran", style: regularTextFont.copyWith(fontSize: fontSize(16), color: textColor()),),
              hSpace(15),
